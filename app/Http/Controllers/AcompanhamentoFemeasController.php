    ...
    public function show(int $id)
    {
        ...
        return response()->json([
            'item' => [
                ...
                'tipo' => $this->tipoLabel($row->tipo_compra),
                'tipo_key' => (string) $row->tipo_compra,
                'data_nascimento' => PigCycleService::formatDisplayDate(empty($row->data_nascimento) ? null : Carbon::parse($row->data_nascimento)),
                'data_compra' => PigCycleService::formatDisplayDate(empty($row->data_compra) ? null : Carbon::parse($row->data_compra)),
                'data_cobertura' => PigCycleService::formatDisplayDate(empty($row->data_cobertura) ? null : Carbon::parse($row->data_cobertura)),
