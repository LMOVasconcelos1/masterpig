...
@section('content')
    <div x-data="{ tab: 'lancamentos' }" class="space-y-6">
        ...
        <div class="mb-6 -mx-3 sm:-mx-6 px-3 sm:px-6 bg-white dark:bg-gray-900 border-b border-gray-200 dark:border-gray-800">
            <div class="pt-4 pb-2">
                <h2 class="text-xl font-bold text-gray-900 dark:text-gray-100">Creche</h2>
                <p class="text-sm text-gray-500 dark:text-gray-400">Manejo de leitões em fase de creche</p>
            </div>
