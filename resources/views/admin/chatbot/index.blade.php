...
<div class="max-w-3xl mx-auto" x-data="{
    ...
    <div class="bg-white rounded-2xl border border-gray-100 shadow-sm overflow-hidden">
        <div class="px-5 py-4 border-b border-gray-100 bg-gray-50/50 flex items-center justify-between">
            <div>
                <div class="font-bold text-gray-900">Assistente do MasterPig</div>
                <div class="text-sm text-gray-500">Respostas baseadas no banco de dados.</div>
            </div>
        </div>
        <div x-ref="list" class="p-5 space-y-3 h-[60vh] overflow-y-auto bg-white">
        ...
        <div class="p-4 border-t border-gray-100 bg-gray-50/50">
            <form @submit.prevent="send()" class="flex items-end gap-3">
                <div class="flex-1">
                    ...
                    ></textarea>
                    <div class="mt-1 text-xs text-gray-500">Enter envia, Shift+Enter quebra linha.</div>
                </div>
