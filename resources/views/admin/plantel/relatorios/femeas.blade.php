...
<body>
    ...
    <div class="actions">
        ...
        <div class="actions-right">
            <a class="btn btn-primary" href="{{ route('admin.relatorios.plantel.femeas', ['format' => 'pdf']) }}">Gerar PDF</a>
            <a class="btn" href="{{ route('admin.relatorios.plantel.femeas', ['format' => 'csv']) }}">Baixar CSV</a>
        </div>
    </div>
    @endif
