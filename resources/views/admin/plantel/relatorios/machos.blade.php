        ...
        * { font-family: Helvetica, Arial, sans-serif !important; }
        ...
        @if (!empty($isPdf))
            ...
            * { margin: 0; padding: 0; box-sizing: border-box; }
            ...
            td.c-id { width: 14%; font-weight: 700; text-align: left; }
            td.c-id2 { width: 14%; color: #2a2a2a; text-align: left; }
            td.c-raca { width: 16%; text-align: left; }
            td.c-local { width: 14%; color: #2a2a2a; text-align: left; }
            td.c-baia { width: 10%; text-align: center; font-weight: 700; }
            td.c-data { width: 12%; color: #2a2a2a; text-align: left; }
            td.c-ultop { width: 12%; font-size: 7.8px; color: #2a2a2a; text-align: left; }
            td.c-status { width: 8%; text-align: center; }
            th.c-id, th.c-id2, th.c-raca, th.c-local, th.c-data, th.c-ultop { text-align: left !important; }
            th.c-baia { text-align: center !important; }
            .badge-ok, .badge-bad {
                display: inline;
                padding: 1px 5px;
                border-radius: 2px;
...
@if (!empty($isPdf))
    ...
    <div class="page">
        <table class="doc-header" cellspacing="0" cellpadding="0">
            <tr>
                ...
                <td class="meta">
                    ...
                    <div style="margin-top:3px;"><strong>Segmento:</strong> Machos</div>
                </td>
            </tr>
        </table>
        ...
        <table class="doc-title-wrap" width="100%" align="center" cellspacing="0" cellpadding="0">
            <tr>
                <td align="center">
                    <h1>Relatório de Plantel — Machos</h1>
                    <div class="doc-subtitle">Controle Geral de Reprodutores</div>
                </td>
            </tr>
        </table>
        ...
        <table class="stats-grid" cellspacing="8">
            <tbody>
                <tr>
                    <td><div class="stat-num">{{ $total }}</div><div class="stat-lbl">Total de Machos</div></td>
                    <td><div class="stat-num">{{ $ativas }}</div><div class="stat-lbl">Ativos</div></td>
                    <td><div class="stat-num">{{ $inativas }}</div><div class="stat-lbl">Inativos</div></td>
                </tr>
            </tbody>
        </table>
